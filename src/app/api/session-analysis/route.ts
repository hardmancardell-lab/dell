...
import { runSessionSequenceAnalysis } from "@/lib/agents/trading-agent/skills/session-sequence-analysis";
...
export async function GET(request: Request) {
  ...
  try {
    const result = await runSessionSequenceAnalysis(ticker, lookbackDays);
